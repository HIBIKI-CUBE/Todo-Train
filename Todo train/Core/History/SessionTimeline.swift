...
//  Todo train
//
//  Day-clock layout for 履歴. Wall-clock minutes are equal — idle between rides is never collapsed.
//
...
enum SessionTimeline {
    ...
    static func markerLabel(_ marker: TimelineMarker) -> String {
        ...
        case .pause:
            ...
            return "停車"
        case .arrived:
            return ClosureKind.arrived.displayLabel
        case .partialDisembark:
            return ClosureKind.partialDisembark.displayLabel
        case .abandoned:
            return ClosureKind.abandoned.displayLabel
        }
    }
    ...
    static func spokenSummary(for ride: TimelineRide, timeFormatter: DateFormatter) -> String {
        ...
        switch ride.outcome {
        case .partialDisembark:
            terminal = SessionOutcome.partialDisembark.displayLabel
        case .abandoned:
            terminal = SessionOutcome.abandoned.displayLabel
        default:
