...
struct HistoryView: View {
    ...
    private var timetableBands: [TimetableFit.Block] {
        timetableBlocks.map {
            TimetableFit.Block(
                id: $0.id,
                title: $0.title,
    ...
    private func reissue(from ticket: Ticket) {
        ...
        ArrivalForecastStore.shared.prefetch(ticket: copy, sessions: Array(sessions), priority: .user)
    }
