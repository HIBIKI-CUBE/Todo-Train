...
最終更新: 2026-09-06（同期は X-09 / [13](13-sync-mac-companion.md)。Mac 体験は [14](14-mac-companion-ux.md) で確認待ち）
...
| Mac Companion | 土管は [13](13-sync-mac-companion.md)。体験は [14](14-mac-companion-ux.md) 確認待ち。実装は未着手 |
