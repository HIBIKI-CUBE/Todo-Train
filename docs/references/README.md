...
| E233 計器モニタの表示灯（速度計の上。文字が灯） | 矩形の表示灯。運行・占有・編成 | ATS 灯、列番、マスコン |
| Garmin G1000 PFD power-up（[Pilots Guide 1.5](https://static.garmin.com/pumac/190-00498-08_0A_Web.pdf)） | 盤が満ち、時計が実時刻へ収まる | ロゴ、AHRS 英文、自己診断完了をピークにしない |
